...
public class StartTimePreference extends TimePreference {
    ...
    private final int mDefaultChargingControlStartTime;

    public StartTimePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mResolver = context.getContentResolver();
        mDefaultChargingControlStartTime = context.getResources()
                .getInteger(R.integer.config_defaultChargingControlStartTime);
    }
    ...
    protected int getTimeSetting() {
        return LineageSettings.System.getInt(mResolver,
                ...
                mDefaultChargingControlStartTime);
    }
    ...
    protected void resetTimeSetting() {
        setTimeSetting(mDefaultChargingControlStartTime);
    }
}
