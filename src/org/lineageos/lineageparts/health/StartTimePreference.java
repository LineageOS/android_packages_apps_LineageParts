...
public class StartTimePreference extends TimePreference {
    ...
    private final int mDefaultBatteryHealthStartTime;

    public StartTimePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mResolver = context.getContentResolver();
        mDefaultBatteryHealthStartTime = context.getResources()
                .getInteger(R.integer.config_defaultBatteryHealthStartTime);
    }

    @Override
    protected int getSummaryResourceId() {
        return R.string.battery_health_start_time_summary;
    }
    ...
    protected int getTimeSetting() {
        return LineageSettings.System.getInt(mResolver,
                ...
                mDefaultBatteryHealthStartTime);
    }
    ...
    protected void resetTimeSetting() {
        setTimeSetting(mDefaultBatteryHealthStartTime);
    }
}
