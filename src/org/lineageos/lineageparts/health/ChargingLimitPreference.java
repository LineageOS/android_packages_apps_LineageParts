...
public class ChargingLimitPreference extends Preference
    ...
    private final int mDefaultChargingControlLimit;
    ...
    public ChargingLimitPreference(final Context context, final AttributeSet attrs) {
        ...
        mDefaultChargingControlLimit = context.getResources()
                .getInteger(R.integer.config_defaultChargingControlLimit);
    }
    ...
    protected void resetSetting() {
        setSetting(mDefaultChargingControlLimit);
    }
