...
public class ChargingLimitPreference extends SliderPreference
    ...
    public void onBindViewHolder(final PreferenceViewHolder holder) {
        ...
        mChargingLimitValue = (TextView) holder.findViewById(android.R.id.text2);

        mLabelFrame = holder.findViewById(R.id.label_frame);
        mLabelFrame.setVisibility(View.VISIBLE);
    ...
    public void onStartTrackingTouch(final Slider slider) {
        mLabelFrame.setVisibility(View.GONE);
    }
