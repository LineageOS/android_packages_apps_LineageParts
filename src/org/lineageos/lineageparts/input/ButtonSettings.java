        ...
        */
        ...
        if (homeCategory != null) {
            ...
            if (mHomeLongPressAction != null) {
                if (navbarEnabled) {
                    homeCategory.removePreference(mHomeLongPressAction);
                } else {
                    homeCategory.addPreference(mHomeLongPressAction);
                }
            }
            if (mHomeDoubleTapAction != null) {
                if (navbarEnabled) {
                    homeCategory.removePreference(mHomeDoubleTapAction);
                } else {
                    homeCategory.addPreference(mHomeDoubleTapAction);
                }
            }
        }
