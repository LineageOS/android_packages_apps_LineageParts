...
public class ButtonSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (prefScreen != null && mSwapCapacitiveKeys != null &&
                !mHardware.isSupported(LineageHardwareManager.FEATURE_KEY_SWAP)) {
    ...
    public static void restoreKeySwapper(Context context) {
        ...
        if (!hardware.isSupported(LineageHardwareManager.FEATURE_KEY_SWAP)) {
            return;
        }
