...
public class ButtonSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Do not show split screen option on Go-enabled devices
        if (SystemProperties.get("ro.config.low_ram").equals("true")) {
            String[] actionEntriesGo = getResources().getStringArray(R.array.hardware_keys_action_entries_go);
            String[] actionValuesGo = getResources().getStringArray(R.array.hardware_keys_action_values_go);
