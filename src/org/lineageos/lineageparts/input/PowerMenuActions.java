...
public class PowerMenuActions extends SettingsPreferenceFragment {
    ...
    public void onStart() {
        ...
        if (mEmergencyPref != null) {
            boolean enabled = mEmergencyAffordanceManager.needsEmergencyAffordance();
            mEmergencyPref.setChecked(mLineageGlobalActions.userConfigContains(
                    GLOBAL_ACTION_KEY_EMERGENCY) || enabled);
            mEmergencyPref.setEnabled(!enabled);
        }
    ...
    private void updatePreferences() {
        ...
        if (mEmergencyPref != null && mEmergencyAffordanceManager.needsEmergencyAffordance()) {
            mEmergencyPref.setEnabled(false);
            mEmergencyPref.setChecked(true);
