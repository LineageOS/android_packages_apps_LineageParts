 ...
 */
package org.lineageos.lineageparts.datarestriction;
 ...
 * network policies.
 */
public class DataRestrictionSettings extends SettingsPreferenceFragment implements
     ...
     * String constants.
     */
    public static final String TAG = "DataRestrictionSettings";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.data_restriction_manager_preferences, container, false);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.data_restriction_manager_menu, menu);

        MenuItem blockNewAppsItem = menu.findItem(R.id.data_restriction_block_new_apps);
        MenuItem showSystemAppsItem = menu.findItem(R.id.data_restriction_show_system_apps);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.data_restriction_block_new_apps:
                mNetworkPolicyManager.setRestrictNewApps(item.isChecked());
                break;
            case R.id.data_restriction_show_system_apps:
                mShowSystemApps = item.isChecked();
                reloadAppList();
                break;
            case R.id.data_restriction_block_all_apps:
                setAllNetworkPoliciesEnabled(false);
                break;
            case R.id.data_restriction_unblock_all_apps:
