...
/**
 * Implementation of a view holder for the data restriction manager app list.
 */
public class AppListViewHolder extends RecyclerView.ViewHolder implements
    ...
    public void bindData(AppInfo info) {
        ...
        backgroundDataCheckBox.setChecked(appInfo.isBackgroundDataEnabled());
        dataSaverRestrictionCheckBox.setChecked(appInfo.isDataSaverRestrictionEnabled());
    }
