...
public class FirewallAppListAdapter extends RecyclerView.Adapter
    ...
    public FirewallAppListAdapter() {
        ...
        m_AppList = new ArrayList<FirewallAppInfo>();
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ((FirewallAppListViewHolder) holder).bindData(m_AppList.get(position));
    }
     ...
     */
    @Override
    public void onAppListCheckedChange(FirewallAppInfo appInfo, EnumSet<FirewallAppListChangeFlag> changeFlags) {
        if (m_CheckListener != null)
            m_CheckListener.onAppListCheckedChange(appInfo, changeFlags);
    }
    ...
    public void onAppListItemClicked(FirewallAppInfo appInfo) {
        if (m_ClickListener != null)
            m_ClickListener.onAppListItemClicked(appInfo);
    }
