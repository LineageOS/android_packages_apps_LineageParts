...
public class StatusBarSettings extends SettingsPreferenceFragment
    ...
    private static final String CATEGORY_STATUS_BAR_CLOCK = "status_bar_clock_key";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStatusBarClockCategory =
                (PreferenceCategory) getPreferenceScreen().findPreference(CATEGORY_STATUS_BAR_CLOCK);
