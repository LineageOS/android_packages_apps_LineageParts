...
public class ChargingSoundsSettings extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDefaultPowerSound = "/system/product/media/audio/ui/ChargingStarted.ogg";
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mDefaultPowerSoundUri = audioFileToUri(getContext(), mDefaultPowerSound);

        updateChargingRingtone(curTone);
    }

    public static Uri audioFileToUri(Context context, String audioFile) {
        ...
        cursor.close();
        return Uri.withAppendedPath(MediaStore.Audio.Media.INTERNAL_CONTENT_URI, Integer.toString(id));
    }
