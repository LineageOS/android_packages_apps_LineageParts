...
public class NotificationBrightnessDialogZen extends BrightnessDialog {
    private static String TAG = "NotificationBrightnessDialogZen";

    private Context mContext;

    public NotificationBrightnessDialogZen(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
