...
public class BatteryBrightnessZenDialog extends BrightnessDialog {
    private static String TAG = "BatteryBrightnessZenDialog";

    private Context mContext;

    public BatteryBrightnessZenDialog(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
