...
public class BatteryBrightnessDialogZen extends BrightnessDialog {
    private static String TAG = "BatteryBrightnessDialogZen";

    private Context mContext;

    public BatteryBrightnessDialogZen(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
