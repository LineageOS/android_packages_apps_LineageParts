...
public class BrightnessDialog extends CustomDialogPreference<AlertDialog>
    ...
    private void saveNotificationBrightness() {
        mNotificationBrightness = LineageSettings.System.getIntForUser(mContext.getContentResolver(),
                LineageSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL,
                LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
    }

    private void restoreNotificationBrightness() {
        LineageSettings.System.putIntForUser(mContext.getContentResolver(),
                LineageSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL,
                mNotificationBrightness, UserHandle.USER_CURRENT);
    }

    // Used by NotificationBrightnessDialog
    protected void updateNotificationBrightness(int brightness) {
        mNotificationBrightness = brightness;
    }
