...
public class StartTimePreference extends TimePreference {
    ...
    private final int mDefaultBatteryCareStartTime;

    public StartTimePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mResolver = context.getContentResolver();
        mDefaultBatteryCareStartTime = context.getResources()
                .getInteger(R.integer.config_defaultBatteryCareStartTime);
    }

    @Override
    protected int getSummaryResourceId() {
        return R.string.battery_care_start_time_summary;
    }

    @Override
    protected int getTimeSetting() {
        return LineageSettings.System.getInt(mResolver,
                LineageSettings.System.BATTERY_CARE_START_TIME,
    ...
    protected void resetTimeSetting() {
        setTimeSetting(mDefaultBatteryCareStartTime);
    }
}
