...
public class TargetTimePreference extends TimePreference {
    ...
    private final int mDefaultBatteryCareTargetTime;

    public TargetTimePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mResolver = context.getContentResolver();
        mDefaultBatteryCareTargetTime = context.getResources()
                .getInteger(R.integer.config_defaultBatteryCareTargetTime);
    }

    @Override
    protected int getSummaryResourceId() {
        return R.string.battery_care_target_time_summary;
    }

    @Override
    protected int getTimeSetting() {
        return LineageSettings.System.getInt(mResolver,
                LineageSettings.System.BATTERY_CARE_TARGET_TIME,
    ...
    protected void resetTimeSetting() {
        setTimeSetting(mDefaultBatteryCareTargetTime);
    }
}
