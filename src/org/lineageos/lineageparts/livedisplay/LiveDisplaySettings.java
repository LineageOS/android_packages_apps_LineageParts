...
public class LiveDisplaySettings extends SettingsPreferenceFragment implements Searchable,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (liveDisplayPrefs != null && mReadingMode != null && (isWellbeingEnabled(getContext()) ||
    ...
    private boolean isWellbeingEnabled(Context context) {
        return PackageManagerUtils.isAppEnabled(context,
                context.getString(com.android.internal.R.string.config_defaultWellbeingPackage));
    }
    ...
    public static final Searchable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public Set<String> getNonIndexableKeys(Context context) {
            ...
            if (isWellbeingEnabled(context) ||
                    !config.hasFeature(FEATURE_READING_ENHANCEMENT)) {
