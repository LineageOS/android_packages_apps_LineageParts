...
/**
 * Preference for selection of start and end times for LiveDisplay
 */
public class TimeSelection extends CustomDialogPreference<AlertDialog> {
    private static final String TAG = "TimeSelection";
    ...
    public TimeSelection(Context context, AttributeSet attrs) {
        ...
        setDialogLayoutResource(R.layout.livedisplay_timeselection);
    }
    ...
    private class ColorTemperatureSeekBar implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            mValue.setText(mContext.getResources().getString(
                    R.string.live_display_time_selection_label, displayValue));
        }
