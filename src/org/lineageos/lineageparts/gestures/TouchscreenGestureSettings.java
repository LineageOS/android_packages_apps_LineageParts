...
public class TouchscreenGestureSettings extends SettingsPreferenceFragment {
    ...
    private static final String KEY_TOUCHSCREEN_GESTURE_HAPTICS = "touchscreen_gesture_haptic_feedback";
    ...
    public static final Searchable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public Set<String> getNonIndexableKeys(Context context) {
            ...
            if (!isTouchscreenGesturesSupported(context)) {
                result.add(KEY_TOUCHSCREEN_GESTURE);
                result.add(KEY_TOUCHSCREEN_GESTURE_HAPTICS);
            }
            return result;
        }
    };
