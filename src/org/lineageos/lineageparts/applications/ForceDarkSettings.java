...
public class ForceDarkSettings extends SettingsPreferenceFragment
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.state.setOnCheckedChangeListener((buttonView, isChecked) -> {
                    ...
                    if (isChecked) {
                        mForceDark.addApp(appEntry.info.packageName);
                    } else {
                        mForceDark.removeApp(appEntry.info.packageName);
                    }
                });
            } else {
            ...
            holder.state.setChecked(mForceDark.shouldForceDarkTheme(entry.info.packageName));
            return holder.rootView;
        }
