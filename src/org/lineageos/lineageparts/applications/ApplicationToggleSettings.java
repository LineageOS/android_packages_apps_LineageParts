...
abstract class ApplicationToggleSettings extends SettingsPreferenceFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.application_toggle_layout, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        mApplicationListView = view.findViewById(R.id.application_list_view);
        mApplicationListView.setAdapter(mAllPackagesAdapter);
        mApplicationListView.setEmptyView(view.findViewById(R.id.application_list_empty_view));
    }
    ...
    /**
     * Should the list show the application or not
     */
    abstract boolean shouldShowApplication(ApplicationsState.AppEntry entry);

    /**
     * Called when an application in the list has been (un)selected
     */
    abstract void applicationSelectionChanged(ApplicationsState.AppEntry entry, boolean selected);

    /**
     * should an application be selected or not
     */
    abstract boolean isApplicationSelected(ApplicationsState.AppEntry entry);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                holder = new ViewHolder(mInflater.inflate(
                        R.layout.application_toggle_list_item, parent, false));
                ...
                holder.state.setOnCheckedChangeListener((buttonView, isChecked) -> {
                    ...
                    applicationSelectionChanged(entry, isChecked);
                });
            } else {
            ...
            holder.state.setChecked(isApplicationSelected(entry));
            return holder.rootView;
        }
